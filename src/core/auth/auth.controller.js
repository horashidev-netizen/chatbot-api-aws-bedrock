...
var customize_decorator_1 = require("../decorator/customize.decorator");
var AuthController = function () {
        ...
        AuthController_1.prototype.signIn = function (signInDto) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.authService.validateUser(signInDto.username, signInDto.password)];
                        case 1:
                            validateUser = _a.sent();
                            if (!validateUser) {
                                return [2 /*return*/, {
                                        statusCode: 401,
                            ...
                            return [2 /*return*/, this.authService.login(validateUser)];
                    }
                });
            });
        };
    ...
    (function () {
        ...
        _signIn_decorators = [(0, customize_decorator_1.Public)(), (0, common_1.HttpCode)(common_1.HttpStatus.OK), (0, common_1.Post)('login')];
